...
<!--
  ============================================================
  E-PeriTech — contacto.html
  ============================================================
 --------------CLIENTE SERVIDOR-------------------------
  GUIA #1 - Actividad 2: Capa de Presentacion
  Formulario de contacto del cliente. Implementa la
  captura de datos del usuario antes de enviarlos al
  servidor para validacion y procesamiento remoto.
 --------------CLIENTE SERVIDOR-------------------------
  GUIA #1 - Actividad 3: Procesos del Cliente
  Captura de datos del usuario (formulario de contacto).
  La validacion critica se ejecuta en el servidor PHP,
  no en el cliente, segun la Guia #1 Act. 3.
 --------------CLIENTE SERVIDOR-------------------------
  GUIA #1 - Actividad 4: Payload
  Los datos del formulario se envian como payload JSON
  al servidor siguiendo la estructura definida en la
  Guia #1 Actividad 4.
  ============================================================
-->
...
<body>
    ...
    <header>
        <nav>
            ...
            <div class="nav-icons">
                <!-- FIX 1: Eliminado </button> suelto (stray end tag button) -->
                ...
                <form action="procesar.php" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" id="telefono" name="telefono" required placeholder="+57 3185838072">
                        </div>
                        <div class="form-group">
            ...
            <div class="contact-info-section">
                ...
                <div class="contact-cards">
                   <!-- <div class="contact-card"> -->  
                    ...
                    <!-- FIX 5: Eliminado </div> suelto (stray end tag div) -->

                    <div class="contact-card">
                        <div class="contact-icon">📞</div>
                        <div class="contact-card-content">
                            <h3>Teléfono</h3>
                            <!-- FIX 3 y 4: Espacios eliminados en los href tel: -->
                            <p>Ventas: <a href="tel:+573142800623">+57 314 2800623</a><br>
                            Soporte: <a href="tel:+573166133839">+57 316 6133839</a><br>
                            WhatsApp: <a href="https://wa.me/5731437799697">+57 314 3779969</a></p>
                        </div>
                    </div>
                    ...
                    <div class="contact-card">
                        ...
                        <div class="contact-card-content">
                            ...
                            <p>Ventas: <a href="est_ja_florez@fesc.edu.co">est_ja_florez@fesc.edu.co</a><br>
                            Soporte: <a href="est_ma.florez@fesc.edu.co">est_ma.florez@fesc.edu.co</a><br>
                            General: <a href="est_om_carrillo@fesc.edu.co">est_om_carrillo@fesc.edu.co</a><br>
                            Soporte de la pagina: <a href="mailto:est_sm_morgensztern@fesc.edu.co">est_sm_morgensztern@fesc.edu.co</a></p>
                        </div>
                    </div>
    ...
    <!-- FIX 6: Eliminado </section> duplicado (stray end tag section) -->
